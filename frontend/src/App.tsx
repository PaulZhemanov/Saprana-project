...
const App: React.FC = () => {
    ...
    return (
      <Result
        ...
        extra={[
          <Button
            onClick={() =>
              window.open("https://github.com/PaulZhemanov/Saprana-project")
            }
            type="primary"
            key="console"
          >
  ...
  return (
    <Layout style={{ height: "100vh" }}>
      ...
      >
        <b style={{ color: "white" }}>🥳 SAPRANA</b>
        <div>
          {isConnected ? (
            <div style={{ color: "white" }}>You are connected</div>
          ) : (
            <Button disabled={fuel == null} onClick={fuel.connect}>
              Connect wallet
            </Button>
          )}
        </div>
      ...
      <Content className="site-layout" style={{ padding: "0 50px" }}>
        ...
        >
          <Carousel>
            <div>
              <h3 style={contentStyle}>Saprana test event</h3>
            </div>
            <div>
              <h3 style={contentStyle}>Saprana test event pic1</h3>
            </div>
            <div>
              <h3 style={contentStyle}>Saprana test event pic2</h3>
            </div>
            <div>
              <h3 style={contentStyle}>Saprana test event pic3</h3>
            </div>
          </Carousel>
          ...
          <Button
            ...
            onClick={buyTicket}
          >
            {loading ? "Loading..." : "Buy ticket for 0.01 ETH"}
          </Button>
        </div>
      </Content>
      <Footer style={{ textAlign: "center" }}>
        Saprana nft ticketing platform ©2023{" "}
        <a href="https://github.com/PaulZhemanov/Saprana-project">GitHub</a>
      </Footer>
    </Layout>
  );
};
